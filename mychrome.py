...
r2 = ttk.Combobox(window,values=["Small","Medium","Large","X-Large","One Size"],width=rwidth-3,state="readonly")
r2.current(1)
...
# 버튼
b0 = Button(window,text="조회",command=search,font=anotherLabelFont).grid(row=11,column=0)
b1 = Button(window,text="시작",command=start,font=anotherLabelFont).grid(row=11,column=1)
#b2 = Button(window,text="종료",command=window.quit)

window.mainloop()
###################################
"""url = 'https://shop.palaceskateboards.com/collections/new' #텍스트
item = "PALACE M-ZONE MUTANT FIST HOOD BLACK" # 텍스트
size = 'X-Large' # 리스트
